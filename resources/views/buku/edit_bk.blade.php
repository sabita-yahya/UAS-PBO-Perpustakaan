...
<form action="/bk/update/{{$bk->kode_buku}}" method="POST">
    ...
    <input type="text" name="pengarang" placeholder="Masukan Pengarang" class="form-control" value="{{$bk->pengarang}}"><br>
    ...
    <input type="text" name="stock" placeholder="Masukan Stock" class="form-control" value="{{$bk->stock}}"><br>
